...
export default function ProgramsPage() {
  ...
  useEffect(() => {
    console.log('Programs page useEffect started');
    ...
    loadPrograms();
    console.log('Programs page useEffect completed');
  }, [currentPage, selectedCategory, selectedStatus, selectedCity, sortBy]);
